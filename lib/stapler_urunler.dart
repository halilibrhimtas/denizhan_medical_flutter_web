...
class _StaplerUrunlerState extends State<StaplerUrunler> {
  ...
  List<String> images = [
    "assets/stapler/circular_stapler.png",
    "assets/stapler/endocutter_stapler.png",
    "assets/stapler/hemorrhoids_stapler.pngg",
    "assets/stapler/linear_cutter.png",
    "assets/stapler/skin_stapler.jpg",
  ];
