...
class DisposableLaparaskopikKisimMobile extends StatefulWidget {
  const DisposableLaparaskopikKisimMobile({
    Key? key,
  ...
  @override
  State<DisposableLaparaskopikKisimMobile> createState() => _DisposableLaparaskopikKisimMobileState();
}

class _DisposableLaparaskopikKisimMobileState extends State<DisposableLaparaskopikKisimMobile> {
  List<String> routes = [
