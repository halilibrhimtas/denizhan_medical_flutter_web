...
class DisposableClawGrasperPage extends StatefulWidget {
  const DisposableClawGrasperPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_claw_grasper';


  @override
  State<DisposableClawGrasperPage> createState() => _DisposableClawGrasperPageState();
}

class _DisposableClawGrasperPageState extends State<DisposableClawGrasperPage> {
