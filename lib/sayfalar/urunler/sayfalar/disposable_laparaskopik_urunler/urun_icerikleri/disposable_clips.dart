...
class DisposableClipsPage extends StatefulWidget {
  const DisposableClipsPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_clips';


  @override
  State<DisposableClipsPage> createState() => _DisposableClipsPageState();
}

class _DisposableClipsPageState extends State<DisposableClipsPage> {
  ...
  List<String> images = [
    ...
    "assets/disposable_laparaskopi/polimer_clips/clips2.png",
    "assets/disposable_laparaskopi/polimer_clips/clips3.png",
    "assets/disposable_laparaskopi/polimer_clips/clips4.png"
  ];
