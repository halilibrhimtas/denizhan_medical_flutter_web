...
class DisposableScissorsPage extends StatefulWidget {
  const DisposableScissorsPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_scissors';


  @override
  State<DisposableScissorsPage> createState() => _DisposableScissorsPageState();
}

class _DisposableScissorsPageState extends State<DisposableScissorsPage> {
