...
class DisposableSuctionPage extends StatefulWidget {
  const DisposableSuctionPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_suction';


  @override
  State<DisposableSuctionPage> createState() => _DisposableSuctionPageState();
}

class _DisposableSuctionPageState extends State<DisposableSuctionPage> {
  Color color = const Color(0xff264796);
  int currentIndex = 0;
  List<bool> onTapped = [true, false, false];
  List<String> images = [
    "assets/disposable_laparaskopi/suction/suction.jpeg",
    "assets/disposable_laparaskopi/suction/suction2.png",
    "assets/disposable_laparaskopi/suction/suction3.png",
  ];
