...
class DisposableGrasperPage extends StatefulWidget {
  const DisposableGrasperPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_grasper';


  @override
  State<DisposableGrasperPage> createState() => _DisposableGrasperPageState();
}

class _DisposableGrasperPageState extends State<DisposableGrasperPage> {
  Color color = const Color(0xff264796);
  ScrollController listScrollController = ScrollController();
  int currentIndex = 0;
  List<bool> onTapped = [true, false, false];
  List<String> images = [
    "assets/disposable_laparaskopi/grasper/grasper.png",
