...
class DisposableEndoBagPage extends StatefulWidget {
  const DisposableEndoBagPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_endo_bag';


  @override
  State<DisposableEndoBagPage> createState() => _DisposableEndoBagPageState();
}

class _DisposableEndoBagPageState extends State<DisposableEndoBagPage> {
  Color color = const Color(0xff264796);
  int currentIndex = 0;
  List<bool> onTapped = [true, false, false];
  List<String> images = [
    "assets/disposable_laparaskopi/endo_bag/endo_bag.jpg",
    "assets/disposable_laparaskopi/endo_bag/endo_bag2.png",
  ];
