...
class DisposableDissectorPage extends StatefulWidget {
  const DisposableDissectorPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_dissector';


  @override
  State<DisposableDissectorPage> createState() => _DisposableDissectorPageState();
}

class _DisposableDissectorPageState extends State<DisposableDissectorPage> {
  ...
  List<String> images = [
    ...
    "assets/disposable_laparaskopi/dissector/dissector1.png",
