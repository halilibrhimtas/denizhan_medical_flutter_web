...
class DisposableBipolarForcepsPage extends StatefulWidget {
  const DisposableBipolarForcepsPage({super.key});
  static const String route = '/urunler/disposable_laparaskopik_urunler/disposable_bipolar_forceps';


  @override
  State<DisposableBipolarForcepsPage> createState() => _DisposableBipolarForcepsPageState();
}

class _DisposableBipolarForcepsPageState extends State<DisposableBipolarForcepsPage> {
  ...
  List<String> images = [
    ...
    "assets/disposable_laparaskopi/bipolar_forceps/bipolar_forceps.png"
  ];
