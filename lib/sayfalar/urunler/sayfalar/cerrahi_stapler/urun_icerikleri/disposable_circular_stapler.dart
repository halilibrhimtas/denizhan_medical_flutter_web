...
class DisposableCircularStaplerPage extends StatefulWidget {
  const DisposableCircularStaplerPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/disposable_circular_stapler';


  @override
  State<DisposableCircularStaplerPage> createState() => _DisposableCircularStaplerPageState();
}

class _DisposableCircularStaplerPageState extends State<DisposableCircularStaplerPage> {
  ...
  List<String> images = [
    ...
    "assets/stapler/disposable_circular_stapler/circular_stapler.png",
  ];
