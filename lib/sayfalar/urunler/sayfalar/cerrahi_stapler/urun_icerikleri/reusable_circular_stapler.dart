...
class ReusableCircularStaplerPage extends StatefulWidget {
  const ReusableCircularStaplerPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/reusable_circular_stapler';


  @override
  State<ReusableCircularStaplerPage> createState() => _ReusableCircularStaplerPageState();
}

class _ReusableCircularStaplerPageState extends State<ReusableCircularStaplerPage> {
  ...
  List<String> images = [
    ...
    "assets/stapler/reusable_circular_stapler/reusable_circular_stapler2.png",
    "assets/stapler/reusable_circular_stapler/reusable_circular_stapler_cartridge.png",
  ];
