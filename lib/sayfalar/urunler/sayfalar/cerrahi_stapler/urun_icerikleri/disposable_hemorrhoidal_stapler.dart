...
class DisposableHemorrhoidalStaplerPage extends StatefulWidget {
  const DisposableHemorrhoidalStaplerPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/disposable_hemorrhoidal_stapler';


  @override
  State<DisposableHemorrhoidalStaplerPage> createState() => _DisposableHemorrhoidalStaplerPageState();
}

class _DisposableHemorrhoidalStaplerPageState extends State<DisposableHemorrhoidalStaplerPage> {
