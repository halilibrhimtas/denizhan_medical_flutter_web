...
class ReusableHemorrhoidalStaplerPage extends StatefulWidget {
  const ReusableHemorrhoidalStaplerPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/reusable_hemorrhoidal_stapler';


  @override
  State<ReusableHemorrhoidalStaplerPage> createState() => _ReusableHemorrhoidalStaplerPageState();
}

class _ReusableHemorrhoidalStaplerPageState extends State<ReusableHemorrhoidalStaplerPage> {
