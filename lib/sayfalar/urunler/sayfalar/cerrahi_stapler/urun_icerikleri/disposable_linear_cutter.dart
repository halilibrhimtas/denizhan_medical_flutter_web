...
class DisposableLinearCutterPage extends StatefulWidget {
  const DisposableLinearCutterPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/disposable_linear_cutter';


  @override
  State<DisposableLinearCutterPage> createState() => _DisposableLinearCutterPageState();
}

class _DisposableLinearCutterPageState extends State<DisposableLinearCutterPage> {
  ...
  List<String> images = [
    ...
    "assets/stapler/linear_cutter/kilitli_handle.png",
  ];
  @override
