...
class EndoCutterPage extends StatefulWidget {
  const EndoCutterPage({super.key});
  static const String route = '/urunler/cerrahi_stapler/endo_cutter';


  @override
  State<EndoCutterPage> createState() => _EndoCutterPageState();
}

class _EndoCutterPageState extends State<EndoCutterPage> {
  ...
  List<String> images = [
    ...
    "assets/stapler/endo_cutter/endocutter2.png",
    "assets/stapler/endo_cutter/endocutter_cartridge.png",
  ];
