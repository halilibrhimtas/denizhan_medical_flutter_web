...
class CerrahiStaplerKisim extends StatefulWidget {
  const CerrahiStaplerKisim({
    Key? key,
  ...
  @override
  State<CerrahiStaplerKisim> createState() => _CerrahiStaplerKisimState();
}

class _CerrahiStaplerKisimState extends State<CerrahiStaplerKisim> {
  List<String> routes = [
