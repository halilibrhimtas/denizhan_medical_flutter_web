...
class ReusableDissectorPage extends StatefulWidget {
  const ReusableDissectorPage({super.key});
  static const String route = '/urunler/reusable_laparaskopik_urunler/reusable_dissector';


  @override
  State<ReusableDissectorPage> createState() => _ReusableDissectorPageState();
}

class _ReusableDissectorPageState extends State<ReusableDissectorPage> {
