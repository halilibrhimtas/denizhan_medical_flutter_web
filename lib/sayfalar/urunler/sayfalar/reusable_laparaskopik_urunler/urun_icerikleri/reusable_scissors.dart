...
class ReusableScissorsPage extends StatefulWidget {
  const ReusableScissorsPage({super.key});
  static const String route = '/urunler/reusable_laparaskopik_urunler/reusable_scissors';


  @override
  State<ReusableScissorsPage> createState() => _ReusableScissorsPageState();
}

class _ReusableScissorsPageState extends State<ReusableScissorsPage> {
