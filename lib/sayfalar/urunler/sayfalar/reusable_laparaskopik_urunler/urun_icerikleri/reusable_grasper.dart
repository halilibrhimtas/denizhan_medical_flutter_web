...
class ReusableGrasperPage extends StatefulWidget {
  const ReusableGrasperPage({super.key});
  static const String route = '/urunler/reusable_laparaskopik_urunler/reusable_grasper';


  @override
  State<ReusableGrasperPage> createState() => _ReusableGrasperPageState();
}

class _ReusableGrasperPageState extends State<ReusableGrasperPage> {
