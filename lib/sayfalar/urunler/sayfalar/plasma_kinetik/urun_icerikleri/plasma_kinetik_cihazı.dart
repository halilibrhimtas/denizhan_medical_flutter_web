...
class PlasmaKinetikCihaziPage extends StatefulWidget {
  const PlasmaKinetikCihaziPage({super.key});
  static const String route = '/urunler/plasma_kinetik/plasma_kinetik_cihazi';


  @override
  State<PlasmaKinetikCihaziPage> createState() => _PlasmaKinetikCihaziPageState();
}

class _PlasmaKinetikCihaziPageState extends State<PlasmaKinetikCihaziPage> {
