...
class BipolarLoopPage extends StatefulWidget {
  const BipolarLoopPage({super.key});
  static const String route = '/urunler/plasma_kinetik/bipolar_loop';


  @override
  State<BipolarLoopPage> createState() => _BipolarLoopPageState();
}

class _BipolarLoopPageState extends State<BipolarLoopPage> {
